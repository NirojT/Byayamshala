...
import { useUserPlansStore } from "./store";
...
const AppUserPlans = () => {
  ...
  return (
    <div className="w-full min-h-screen  bg-gray-50 text-[#2E2E2E] p-24 font-poppins">
      {/* Back Button */}
      <Back />
      {/* Table for bigger screens */}
      <div className="overflow-x-auto hidden sm:block mt-6 bg-white shadow-md rounded-lg">
