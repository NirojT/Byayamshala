...
const MemberAttendanceFilters = () => {
  const { searchByMember, filters, setFilters } = useAddAttendanceFormStore();
  const { member } = useListMemberStore();
...
export default MemberAttendanceFilters;
