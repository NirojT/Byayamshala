...
const PreviewCard = () => {
  const { data } = useAddSalesFormStore();
  return (
          ...
          <div className="mt-4 space-y-4">
            {data.partyName && (
              <div className="bg-[#FAFAFA] rounded-lg p-4 border border-gray-100">
                ...
                <p className="text-[#1A1A1A] font-medium">{data.partyName}</p>
            ...
            <div className="bg-[#FAFAFA] rounded-lg p-4 border border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-[#2E2E2E]/80 text-xs">Payment Mode</p>
                  <p className="text-[#1A1A1A] text-sm mt-0.5">
                    {data.paymentMode || "Not selected"}
                  </p>
                </div>
                <div>
                  <p className="text-[#2E2E2E]/80 text-xs">Date</p>
                  <p className="text-[#1A1A1A] text-sm mt-0.5">
            ...
            <div className="bg-[#FAFAFA] rounded-lg p-4 border border-gray-100">
              ...
              <div className="space-y-2">
                {data.salesItemsReq && data.salesItemsReq.length > 0 ? (
