...
const SystemLogsFilter = () => {
  const { searchLogs, filters, setFilters } = useSystemUserStore(); 
  ...
  /*
  when normal navigating the id does not exist so we need to call the searchQuery function to get the Session data
  */
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex-1 min-w-[200px]">
            <FormControl
              ...
              sx={textFieldSx}
            >
              <InputLabel>Session Period</InputLabel>
              <Select
                size="medium"
                name="reportPeriod"
