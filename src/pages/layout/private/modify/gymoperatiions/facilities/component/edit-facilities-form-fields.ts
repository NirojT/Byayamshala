import { IFacilitiesEditFormField, IFacilitiesEditOption } from "../interface";

export const EditFacilitiesFormFields = (): IFacilitiesEditFormField[] => [
  {
    name: "facilityName",
...
export const FacilitiesOptions: IFacilitiesEditOption[] = [
