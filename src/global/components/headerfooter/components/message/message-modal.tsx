...
const MessageModal = () => {
  ...
  const { setSending, data, setData, loading, setLoading, create ,clearData} =
    useClientQueryStore();
      ...
      >
        ...
        <div className="p-6 space-y-5 bg-gray-900/60">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="gymudaan@gmail.com"
                value={data?.email}
        ...
        <div className="bg-gray-800/80 p-6 flex justify-end gap-3 border-t border-gray-800">
          <button
            ...
            className="px-5 py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg text-sm transition-all duration-200 flex items-center font-medium focus:outline-none focus:ring-2 focus:ring-gray-600"
          >
            Cancel
          </button>
